...
--------------------------------------------*/
    ...
    if (animation) {
      ...
      var text = $('#home .typer-title'),
          textOne = "trabalho com, cyber security, software e sou professor",
          textTwo = "vamos trabalhar juntos",
          textThree = "posso te ajudar de várias maneiras";
      ...
      $.ajax({
        ...
        $('#message').val('');
          ...
          if (data.responseText !== '') {
              ...
              formMessages.text('Desculpe! Sua mensagem não pode ser enviada.');
          }
